...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LikeButton.url'
        db.alter_column('cmsplugin_likebutton', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Adding field 'LikeBox.pageurl'
        db.add_column('cmsplugin_likebox', 'pageurl', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'LikeButton.url'
        db.alter_column('cmsplugin_likebutton', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Deleting field 'LikeBox.pageurl'
        db.delete_column('cmsplugin_likebox', 'pageurl')
