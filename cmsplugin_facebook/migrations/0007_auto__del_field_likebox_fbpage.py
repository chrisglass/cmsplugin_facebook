...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LikeBox.fbpage'
        db.delete_column('cmsplugin_likebox', 'fbpage_id')


    def backwards(self, orm):
        
        # We cannot add back in field 'LikeBox.fbpage'
        raise RuntimeError(
            "Cannot reverse this migration. 'LikeBox.fbpage' and its values cannot be restored.")
