...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LikeButton.url'
        db.delete_column('cmsplugin_likebutton', 'url')

        # Adding field 'LikeButton.pageurl'
        db.add_column('cmsplugin_likebutton', 'pageurl', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'LikeButton.url'
        db.add_column('cmsplugin_likebutton', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)

        # Deleting field 'LikeButton.pageurl'
        db.delete_column('cmsplugin_likebutton', 'pageurl')
